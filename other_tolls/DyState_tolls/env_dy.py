...
import random
import math
from other_tolls.DyState_tolls.utils import Graph, Path, Edge
...
class TrafficEnvironment_DY:
    ...
    def create_action_vector(self):
        ...
        for e in self.edges:
            id = e.id
            state_sum = sum(self.state_matrix[id])
            self.action_vector[id] = 6 * (state_sum / 200)
