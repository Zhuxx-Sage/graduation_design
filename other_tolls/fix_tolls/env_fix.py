...
import random
import math
from other_tolls.fix_tolls.utils import Graph, Path, Edge
...
class TrafficEnvironment_FIX:
    ...
    def create_action_vector(self):
        ...
        for e in self.edges:
            ...
            demand = self.traffic_demand(start, end, Path(start, end, [id]))
            self.action_vector[id] = self.upper_bound_action * demand
